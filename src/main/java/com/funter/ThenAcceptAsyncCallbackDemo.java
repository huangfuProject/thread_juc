 ...
 */
public class ThenAcceptAsyncCallbackDemo {
    ...
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        ...
        resFuture.thenAcceptAsync(res ->{
            System.out.println("第二个异步任务的线程名称为：" + Thread.currentThread().getName());
            System.out.println("上一个异步任务的结果集： " + res);
        }, THREAD_POOL_EXECUTOR)
                .get();
